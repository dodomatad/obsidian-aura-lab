...
import infinityAerialYellow from '@/assets/boats/infinity/infinity-aerial-yellow.webp';
import infinityDeckRigging from '@/assets/boats/infinity/infinity-deck-rigging.webp';
import infinityLogoClose from '@/assets/boats/infinity/infinity-logo-close.webp';

import infinitySternRudder from '@/assets/boats/infinity/infinity-stern-rudder.webp';
...
import dwBowLogo from '@/assets/boats/dw/dw-bow-logo.webp';
import dwDeckAngle from '@/assets/boats/dw/dw-deck-angle.webp';
...
import moanaCover from '@/assets/boats/moana/moana-cover.webp';
...
import azimutProfileRear from '@/assets/boats/azimut/azimut-profile-rear.webp';
...
export const productsData: Record<string, Product> = {
  ...
  azimut: {
    id: 'azimut',
    name: 'AZIMUT',
    tagline: 'Surfski Duplo para Lazer e Aventura',
    category: 'Surfski Duplo',
    level: 'Fácil (Todos os Níveis)',
    levelColor: 'text-emerald-400',
    difficultyLevel: 15,
    description: 'Surfski duplo da Opium, projetado para lazer, contemplação, aventura e expedições. Ideal para casais e duplas de todos os níveis, com estabilidade máxima e conforto incomparável.',
    image: azimutProfile,
    specs: {
      length: '6.80m',
      beam: '48cm',
      weight: '19kg',
      capacity: '200kg',
      material: 'Divinicel, Fibra de Carbono e Fibra de Vidro',
    },
    features: [
      'Estabilidade máxima — não capota',
      'Dois cockpits ergonômicos independentes',
      'Sistema de leme por pedal',
      'Ideal para lazer, contemplação e expedições',
      'Perfeito para casais e duplas de todos os níveis',
    ],
    colors: [
    ...
    techProfile: {
      idealFor: ['Iniciantes', 'Intermediários', 'Casais', 'Duplas de todos os níveis'],
      heightRecommendation: 'Todos os tamanhos',
      stability: 'very-high',
      speed: 'high',
      maneuverability: 'high',
      comfort: 'very-high',
      boardingEase: 'easy',
      bestFor: ['Lazer', 'Contemplação', 'Aventura', 'Expedições', 'Travessias em dupla'],
      conditions: ['Mar calmo', 'Represa', 'Rios', 'Qualquer condição'],
      highlights: [
        'Surfski duplo amplo e extremamente estável',
        'Não capota — segurança total para iniciantes',
        'Perfeito para casais e passeios a dois',
        'Cockpits independentes e ergonômicos',
        'Construção em Divinicel, Carbono e Fibra de Vidro',
      ],
      comparedToFleet: 'O único surfski duplo da frota. Foco em lazer, conforto e estabilidade máxima para duplas.',
    },
  },
};
