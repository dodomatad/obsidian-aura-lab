...
export function FabioStory() {
  const data = [
    // 1. O Campeão & Pioneiro (gancho marketing)
    {
    ...
    // 2. A Revolução Havaiana (momento mais impactante)
    {
    ...
    // 3. Legado & Reconhecimento (tocha olímpica)
    {
