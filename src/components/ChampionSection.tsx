        ...
        <div className="relative py-8 md:py-24 lg:py-32" style={{ backgroundColor: '#050505' }}>
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16">
            ...
            >
              ...
              <h2 className="font-sporty text-4xl md:text-5xl lg:text-6xl mt-4 mb-6 text-orange font-bold uppercasge font-bold uppercase">
                NOSSOS DIFERENCIAIS
              </h2>
            </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
          ...
          <div className="relative flex flex-col justify-center px-6 sm:px-8 md:px-12 lg:px-16 xl:px-24 py-12 md:py-16 lg:py-24">
            ...
            >
              ...
              >
                <span className="text-3xl md:text-5xl tracking-[0.05em] uppercsporty font-boldext-orange font-brush whitespace-nowrap">
                  A Origem
                </span>
              </motion.div>
